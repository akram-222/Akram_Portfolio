              ...
              <form className="space-y-4 md:space-y-6" action="#">
                <div className="relative">
                  ...
                  <input
                    ...
                    placeholder="gh**************************************"
                    className={`pl-10 border border-gray-300 sm:text-sm text-${colorState}-400 rounded-lg focus:ring-${colorState}-600 focus:border-${colorState}-600 block w-full p-2.5 dark:bg-gray-700 dark:border-${colorState}-600 dark:placeholder-gray-400 dark:text-${colorState}-600 dark:focus:ring-${colorState}-500 dark:focus:border-${colorState}-500`}
                    required
                  />
                  <BsKey size={25} className="dark:text-gray-500 absolute top-1/2 left-2" />
                </div>
                <button
                  type="submit"
