  ...
  return (
    <>
      <div className="h-full w-full">
        <div className="h-full w-full mx-auto py-7 overflow-y-auto overflow-x-hidden">
          <div className="flex justify-between items-center px-3 pb-5 border-b border-gray-100">
                      ...
                      <div>
                        ...
                        >
                          ...
                          <div className="relative -left-6">
                            ...
                            />
                            {/* line */}
                            <div className="bg_search_4 block bg-indigo-100 w-10 h-6 rounded-full" />
                            {/* dot */}
                            <div className="dot_search_4 absolute left-1 top-1 bg-white w-4 h-4 rounded-full transition" />
                          </div>
                        </label>
                      </div>
                    </div>
                      ...
                      <div>
                        ...
                        >
                          ...
                          <div className="relative -left-6">
                            ...
                            />
                            {/* line */}
                            <div className="bg2_search_4 block bg-indigo-100 w-10 h-6 rounded-full" />
                            {/* dot */}
                            <div className="dot2_search_4 absolute left-1 top-1 bg-white w w-4 h-4 rounded-full transition" />
                          </div>
                        </label>
                      </div>
                    </div>
                      ...
                      <div>
                        ...
                        >
                          ...
                          <div className="relative -left-6">
                            ...
                            />
                            {/* line */}
                            <div className="bg3_search_4 block bg-indigo-100 w-10 h-6 rounded-full" />
                            {/* dot */}
                            <div className="dot3_search_4 absolute left-1 top-1 bg-white w-4 h-4 rounded-full transition" />
                          </div>
                        </label>
                      </div>
                    </div>
                      ...
                      <div>
                        ...
                        >
                          ...
                          <div className="relative -left-6">
                            ...
                            />
                            {/* line */}
                            <div className="bg4_search_4 block bg-indigo-100 w-10 h-6 rounded-full" />
                            {/* dot */}
                            <div className="dot4_search_4 absolute left-1 top-1 bg-white w-4 h-4 rounded-full transition" />
                          </div>
                        </label>
                      </div>
                    </div>
                      ...
                      <div>
                        ...
                        >
                          ...
                          <div className="relative -left-6">
                            ...
                            />
                            {/* line */}
                            <div className="bg5_search_4 block bg-indigo-100 w-10 h-6 rounded-full" />
                            {/* dot */}
                            <div className="dot5_search_4 absolute left-1 top-1 bg-white w-4 h-4 rounded-full transition" />
                          </div>
                        </label>
                      </div>
                    </div>
