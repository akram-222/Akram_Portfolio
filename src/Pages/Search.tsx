          ...
          <div className="flex justify-between items-center px-3 pb-5 border-b dark:border-[#353535]">
            ...
            <div className="">
              <div className="relative w-full">
                ...
                <SearchPreferences isSearchOptionHidden={isSearchOptionHidden} toggleSearchOptionVisibility={toggleSearchOptionVisibility}/>
              </div>
            </div>
          </div>
          <div className="">
            ...
            <div className="px-3 pt-4">
              <div>
                <p className="text-base font-semibold leading-none text-green-400">Users</p>
                <SearchResultItem />
                <SearchResultItem />
              </div>
            </div>
