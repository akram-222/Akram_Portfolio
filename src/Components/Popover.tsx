const Popover = ({ follower: { html_url, avatar_url, login, id, type } }) => {
  return (
    <div
      className={`-bottom-[-115%] opacity-0 invisible group-hover:visible group-hover:opacity-100 absolute z-max inline-block w-64 text-sm font-light text-gray-500 transition-opacity duration-300 bg-white border border-gray-200 rounded-lg shadow-sm  dark:text-gray-400 dark:bg-gray-800 dark:border-gray-600 after:content-[''] after:border-b after:border-r after:z-10 dark:after:border-gray-400 dark:after:bg-gray-800 after:absolute after:translate-y-1/2 after:-translate-x-1/2 after:rotate-45 after:left-2/4 after:bottom-0 after:h-4 after:w-4 after:bg-red-600`}
    >
      <div className="p-3">
