...
function Sidebar() {
  ...
  return (
    ...
    <div
      className={`
        fixed inset-y-0 left-0 bg-gray-200 transition w-0 flex border-r border-gray-300 dark:border-transparent dark:bg-card  flex-col z-10
      ${isSidebarOpen ?  "sm:w-20 xl:w-60":""}
        `}
    >
