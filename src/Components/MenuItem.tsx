...
function MenuItem({ item: { id, title, notifications }, onClick }) {
  ...
  return (
    ...
    <Link
      ...
      : "sidebar-item"} text-gray-800 dark:text-gray-500/80 hover:text-gray-600 dark:hover:text-blue-400 w-full mt-6 flex items-center px-3 sm:px-0 xl:px-3 justify-start sm:justify-center xl:justify-start sm:mt-6 xl:mt-3 cursor-pointer`}
      onClick={() => onClick(id)}
    >
      <SidebarIcons id={id} />
