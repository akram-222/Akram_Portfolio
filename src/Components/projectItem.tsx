...
const ProjectItem = ({ name, createdAt, language, fork, visibility, i }) => {
  return (
    <div
      className={`border add-component-head relative mr-auto w-full md:w-[45%] bg-white rounded-lg shadow-md px-4 dark:bg-[#171717] dark:border-[#353535] py-3 mb-8`}
    >
     ...
     <div className=" flex justify-between items-center">
         <span className="text-white text-xl font-semibold my-2 whitespace-nowrap overflow-hidden w-2/3 text-ellipsis">{i+1}. {name}</span>
