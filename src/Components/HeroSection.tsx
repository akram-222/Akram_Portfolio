      ...
      <section className="bg-white dark:bg-[#171717] mb-5">
        <div className=" pb-1 px-4 mx-auto max-w-screen-xl text-center lg:py-8 lg:px-8">
          ...
          <div className="flex flex-col space-y-4 sm:flex-row sm:justify-center sm:space-y-0 sm:space-x-4">
            <a
              href="#d"
              className="w-fit m-auto inline-flex justify-between items-center py-1 px-1 pr-4 mb-7 text-sm text-gray-700 bg-gray-100 rounded-full dark:bg-gray-800 dark:text-white "
              role="alert"
            >
              ...
              <a
                ...
                className="group flex items-center dark:text-blue-400 dark:hover:underline text-sm font-medium"
              >
