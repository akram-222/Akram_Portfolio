...
const RepoMoreOptions = () => {
    const [isHidden, setHidden] = useState(true)
    return (
        <>

            <div data-dial-init className="fixed right-6 bottom-6 group">
                <div id="speed-dial-menu-default" className={`${isHidden ? "hidden" : ""} flex flex-col items-center mb-4 space-y-2`}>
                    ...
                    <div id="tooltip-copy" role="tooltip" className="absolute z-10 transition -translate-x-full inline-block w-auto px-3 py-2 text-sm font-medium text-white transition-opacity duration-300 bg-gray-900 rounded-lg shadow-sm  tooltip dark:bg-gray-700">
                        Copy
                        <div className="tooltip-arrow" data-popper-arrow></div>
                    </div>
                </div>
                <button onClick={()=>setHidden(!isHidden)} type="button" data-dial-toggle="speed-dial-menu-default" aria-controls="speed-dial-menu-default" aria-expanded="false" className="flex items-center justify-center text-white bg-blue-700 rounded-full w-14 h-14 hover:bg-gray-800/20 dark:bg-gray-700/20 dark:hover:bg-gray-700 focus:ring-4 focus:ring-gray-300 focus:outline-none dark:focus:ring-gray-800">
...
export default RepoMoreOptions