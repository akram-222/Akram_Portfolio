        ...
        <div className="flex p-4 flex-col h-full overflow-y-auto">
            ...
            {gitHubRepos.map(({ name, has_issues, svn_url }, index: number) => (
                <div className="flex items-center mt-3" key={index}>
                    ...
                    <div className="ml-2 whitespace-nowrap text-ellipsis mr-3">{name}</div>
            ...
            <div className="flex justify-center mt-4">
                <a href="https://github.com/Ak-ram" type="button" className="text-white bg-[#050708] hover:bg-[#050708]/80 font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center dark:hover:bg-[#050708]/40 mr-2 mb-2">
                    GitHub Account
                    <svg height="32" aria-hidden="true" viewBox="0 0 16 16" version="1.1" width="32" data-view-component="true" className="fill-white w-6 ml-2 octicon octicon-mark-github v-align-middle">
