import { TbLayoutSidebarLeftExpand,TbBrandLinkedin,TbLayoutSidebarRightExpand,TbBrandTwitter } from "react-icons/tb";
  ...
  return (
    ...
    >
      <ol className="flex sticky top-0 p-1 gap-2 w-full space-x-1 md:space-x-3">
        ...
        <li className="dark:text-gray-400 text-sm font-bold flex items-center border-l-2 pl-2">
Share this page on         </li>
        <li className="cursor-pointer inline-flex font-medium text-gray-700 hover:text-gray-900 dark:text-gray-400 dark:hover:text-white">
