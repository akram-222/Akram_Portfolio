import { TbLayoutSidebarLeftExpand,TbLayoutSidebarRightExpand,TbBrandTwitter } from "react-icons/tb";
...
const BreadCrumb = () => {
  ...
  return (
    ...
    >
      <ol className="flex sticky top-0 p-1 gap-2 w-full items-self-start space-x-1 md:space-x-3">
